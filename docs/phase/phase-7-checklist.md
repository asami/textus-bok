...
- [ ] Stable design and specification documents define `official`,
  `development`, and `project` as closed profile kinds with distinct ownership
  and trust semantics.
- [ ] The contract fixes `official` as the omitted-selector default, documents
...
- [ ] The contract defines how a profile resolves to source/dataset/generation,
...
- [ ] Unregistered, unavailable, stale, ambiguous, unauthorized, and conflicting
